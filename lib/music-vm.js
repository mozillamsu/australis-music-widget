...
function ViewModel() {
    ...
    function trackSelected(track) {
        ...
        musicPlayer.setFileURL('file://' + track.FileURL);
    }
    ...
    function addTrackToPlaylist(track) {
        ...
        let fileURL = String.concat('', track.FileURL);
    ...
    function fillTime() {
        ...
        lblElapsed.setAttribute('value', min + ':' + sec);
    }
    ...
    function populateView() {
        ...
        btnSetLibrary.addEventListener('click', btnSetLibraryClicked);
